...
def export_teams_excel():
    ...
    for t in teams:
        rows.append({
            ...
            "Status Login": t.get("status_login", "LOGADA" if (t.get("marcacao") and t.get("marcacao") != "--") else "PROGRAMADA"),
...
def export_bid_reconciliation_excel():
    ...
    for r in rows:
        excel_rows.append({
            ...
            "Região": r.get("geo", ""),
            "Turno": r.get("turno", ""),
            "Status Prog": r.get("status_prog", r.get("status_eb", "")),
            "Status Login": r.get("status_login", ""),
